...
use cw721::{ContractInfoResponse, Cw721, Expiration, Investor};
    ...
    E: CustomMsg,
{
    ...
    pub deposit_denom:Item<'a, String>,
    ...
    Q: CustomMsg,
{
    fn new(
        ...
        Self {
            ...
            deposit_denom: Item::new(deposit_denom_key),
